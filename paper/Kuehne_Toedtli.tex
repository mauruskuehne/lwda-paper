...
This paper is organized as follows. In chapter~\ref{sec:methods} we review the basic methods to generate adversarial and universal adversarial perturbations as introduced by Moozavi-Dezfooli et al.~\cite{moosavidezfooli_universal_2017}. We then present three modifications of their UAP generation algorithm to combine UAPs for several networks. In chapter~\ref{sec:Results} we first describe our reproduction effort of the original work of Moozavi-Dezfooli et al.~\cite{moosavidezfooli_universal_2017} to produce UAPs on a set of networks and provide our fooling rates. We then present our results on the three methods to produce UAPs for several networks. In chapter~\ref{sec:Discussion} we conclude with a discussion of these results.
...
\section{Results}\ref{sec:Results}
